...
- =M-x ready-player-search-bookmarks= (bound to =k=): Search through your bookmarks with a completing-read interface showing title, artist, and album.
- =M-x ready-player-open-my-bookmarks=: Open all bookmarked files in a =dired= buffer for playback.
